...
public class TimeBonusOrange(primary: Color) {
    val vector : ImageVector = ImageVector.Builder(
            name = "space.itoncek.trailcompass.ui.theme.ComposeTestTheme.TimeBonusOrange",
            ...
            // M16.23 9.3 a2.3 2.3 0 0 0 -1.18 -1.96 L13.87 9.3z
            path(
                fill = SolidColor(Color(0xFFFF8C00)),
            ) {
                // M 11.013037 6.6086617
                moveTo(x = 11.013037f, y = 6.6086617f)
                // a 5.2566037 5.2566037 0 0 0 4.479541 2.6968663
                arcToRelative(
                    a = 5.2566037f,
                    b = 5.2566037f,
                    theta = 0.0f,
                ...
                // L 11.013037 12.002392z
                lineTo(x = 11.013037f, y = 12.002392f)
                close()
            }
            // M11 5.52 V3.5
            path(
        ...
        }.build().also { _timeBonusOrange = it }
    }
...
private fun IconPreview() {
    space.itoncek.trailcompass.ui.theme.ComposeTestTheme {
        Column(
            ...
            Image(
                imageVector = TimeBonusOrange(MaterialTheme.colorScheme.onPrimary).vector,
...
private var _timeBonusOrange: ImageVector? = null
