...
public class TimeBonusRed(primary: Color) {
    val vector : ImageVector =  ImageVector.Builder(
            name = "space.itoncek.trailcompass.ui.theme.ComposeTestTheme.TimeBonusRed",
            ...
            // M16.23 9.3 a2 2 0 0 0 -.32 -1.13 l-2.04 1.14z
            path(
                fill = SolidColor(Color(0xFFFC1403)),
            ) {
                // M 11.013037 6.6086617
                moveTo(x = 11.013037f, y = 6.6086617f)
                // a 4.57096 4.57096 0 0 0 2.5825925 0.7313536
                arcToRelative(
                    a = 4.57096f,
                    b = 4.57096f,
                    theta = 0.0f,
                ...
                // l -2.6054473 4.6623793z
                lineToRelative(dx = -2.6054473f, dy = 4.6623793f)
                close()
            }
            // M11 5.52 V3.5
            path(
...
private fun IconPreview() {
    space.itoncek.trailcompass.ui.theme.ComposeTestTheme {
        Column(
            ...
            Image(
                imageVector = TimeBonusRed(MaterialTheme.colorScheme.onPrimary).vector,
...
private var _timeBonusRed: ImageVector? = null
