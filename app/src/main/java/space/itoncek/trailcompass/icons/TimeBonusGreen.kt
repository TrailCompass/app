...
public class TimeBonusGreen(primary: Color) {
    val vector : ImageVector = ImageVector.Builder(
       name = "space.itoncek.trailcompass.ui.theme.ComposeTestTheme.TimeBonusGreen",
       ...
       // M16.23 9.3 a2.3 2.3 0 0 0 -2.36 -2.27 2.4 2.4 0 0 0 -1.18 .3 l1.18 1.98z
       path(
           fill = SolidColor(Color(0xFF23A920)),
       ) {
           ...
           // a 5.4851522 5.4851522 0 0 0 -0.68564403 2.6968663
           arcToRelative(
               a = 5.4851522f,
               b = 5.4851522f,
               theta = 0.0f,
           ...
           // l -4.5252504 -2.6968663z
           lineToRelative(dx = -4.5252504f, dy = -2.6968663f)
           close()
       }
       // M11 5.52 V3.5
       path(
...
private fun IconPreview() {
    space.itoncek.trailcompass.ui.theme.ComposeTestTheme {
        Column(
            ...
            Image(
                imageVector = TimeBonusGreen(MaterialTheme.colorScheme.onPrimary).vector,
...
private var _timeBonusGreen: ImageVector? = null
