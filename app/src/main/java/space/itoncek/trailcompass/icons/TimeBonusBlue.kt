...
class TimeBonusBlue(primary: Color) {
    val vector : ImageVector = ImageVector.Builder(
        name = "space.itoncek.trailcompass.ui.theme.ComposeTestTheme.TimeBonusBlue",
        ...
        // M16.23 9.3 a2.3 2.3 0 0 0 -2.36 -2.27 2.3 2.3 0 0 0 -2.36 2.28z
        path(
            fill = SolidColor(Color(0xFF3085F5)),
        ) {
            ...
            // a 5.2566037 5.2566037 0 0 0 -5.2108946 5.3937325z
            arcToRelative(
                a = 5.2566037f,
                b = 5.2566037f,
                theta = 0.0f,
...
private fun IconPreview() {
    space.itoncek.trailcompass.ui.theme.ComposeTestTheme {
        Column(
            ...
            Image(
                imageVector = TimeBonusBlue(MaterialTheme.colorScheme.onPrimary).vector,
...
private var _timeBonusBlue: ImageVector? = null
