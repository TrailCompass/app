package space.itoncek.trailcompass.app.hideandseek.seeker_ui;
...
import space.itoncek.trailcompass.app.hideandseek.hider_ui.HiderMapView;
import space.itoncek.trailcompass.client.api.HideAndSeekAPI;

public class SeekerMapView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!amIHider()) {
            ...
            Intent i = new Intent(this, HiderMapView.class);
            startActivity(i);
            finish();
        }
    }
    ...
    private void setUsername() {
        Thread t = new Thread(()-> {
            try {
                ...
                Log.e(SeekerMapView.class.getName(), "Unable to contact the main server", e);
            }
        });
        t.start();
    }
